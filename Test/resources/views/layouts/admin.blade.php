    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        <li class="active treeview menu-open">
          <a href="#">
            <i class="fa fa-mobile"></i> <span>Mobile</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('mobile.create')}}"><i class="fa fa-circle-o"></i> Create </a></li>
            <li><a href="{{route('mobile.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
          </ul>
        </li>
          <li class="active treeview menu-open">
              <a href="#">
              ...
              <ul class="treeview-menu">
                  <li class="active"><a href="{{ route('laptop.create') }}"><i class="fa fa-circle-o"></i> Create </a></li>
                  <li><a href="{{ route('laptop.index') }}"><i class="fa fa-circle-o"></i> Index</a></li>
              </ul>
          </li>
